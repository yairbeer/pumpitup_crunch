...
for params in ParameterGrid(param_grid):
    ...
    for i_mc in range(params['n_monte_carlo']):
        ...
        for cv_train_index, cv_test_index in kf:
            ...
            y_train, y_test = train_labels.iloc[cv_train_index].values, train_labels.iloc[cv_test_index].values
    ...
    if params['mc_test']:
        ...
        for i_mc in range(params['n_monte_carlo']):
            params['seed'] = i_mc
            xg_train = xgboost.DMatrix(train, label=train_labels.values)
...
# Added measurement year, weekday, month, week of the year and age:
